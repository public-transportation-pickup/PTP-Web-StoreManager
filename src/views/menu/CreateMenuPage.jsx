...
export default function CreateMenuPage() {
  ...
  return (
    <div className="relative flex flex-col min-w-0 break-words mx-auto max-w-[73rem] mb-6 shadow-lg rounded bg-white">
                    ...
                    <form action="#">
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div className="w-full">
                                ...
                                <input type="date" multiple={true} name="endDate" id="endDate" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required=""/>
                            </div>
                            <div className="w-full">
                                <label htmlFor="dateApply" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ngày kết thúc</label>
                                {/* <input type="week" name="endDate" id="endDate" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required=""/> */}

        ...
        <div className="relative overflow-x-auto">
            {listDeliveryOrder.length >0 ?(
                ...
                {listDeliveryOrder.length >0 && listDeliveryOrder.slice(currentPage*5, currentPage*5+5).map((item,index)=>(
                    ...
                    <td className="px-2 py-2 border  h-20 w-56  border-slate-300">
                        <div className="flex text-center mx-auto px-5 ">
                            <button type="button" onClick={()=>handleConfirm(item.id)} className="bg-indigo-500 hover:opacity-80 rounded-md mr-2 text-black p-4 py-1 text-sm">Đã giao</button>

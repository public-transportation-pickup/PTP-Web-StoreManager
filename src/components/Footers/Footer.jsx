...
export default function Footer() {
  return (
    <>
      <footer className="relative bg-cyan-200 pt-8 pb-6">
        <div
          ...
          <div className="flex flex-wrap text-center lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              ...
              <div className="mt-6 lg:mb-0 mb-6">
                ...
                <button
                  className="bg-white text-cyan-800 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
                  type="button"
                >
              ...
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a
                        className="text-cyan-600 hover:text-cyan-800 font-semibold block pb-2 text-sm"
